...
us.personal.expenditure$category[which.max(us.personal.expenditure$X1960)]
...
DetectHighest <- function(year) {
  ...
  highest.spending <- us.personal.expenditure$category[which.max(us.personal.expenditure[[column]])]
